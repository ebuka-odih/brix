                            ...
                            <div class="col-lg-12">
                                <div class="card card-bordered card-full">
                                    ...
                                    <div class="card-inner">
                                        <button type="button" class="btn btn-primary m-4" data-bs-toggle="modal" data-bs-target="#modalForm">Add Signal</button>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('admin.signal.update', $item->id) }}" method="POST" class="form-validate is-alter" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form id="deleteForm" method="POST" action="{{ route('admin.signal.destroy', $item->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
    ...
    <div class="modal fade" id="modalForm">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.signal.store') }}" method="POST" class="form-validate is-alter" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-label" for="full-name">Leverage</label>
                                    <div class="form-control-wrap">
                                        <input type="number" step="0.001" name="leverage" class="form-control" id="full-name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-label" for="email-address">Interest</label>
                                    <div class="form-control-wrap">
                                        <input type="number" step="0.001" name="percent" class="form-control" id="email-address" required>
                                    </div>
                                </div>
                            </div>
                        </div>
