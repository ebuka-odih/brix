...
@section('content')
                ...
                <div class="nk-content-body">
                    ...
                    <div class="nk-block">
                            ...
                            <div class="col-lg-12">
                                <div class="card card-bordered card-full">
                                    ...
                                    <div class="card-inner">
                                        <button type="button" class="btn btn-primary m-4" data-bs-toggle="modal" data-bs-target="#modalForm">Add Bot Plan</button>
                                        <h4 class="m-2">Bot Trading Plans</h4>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('admin.botplan.update', $item->id) }}" method="POST" class="form-validate is-alter" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-label" for="full-name">Leverage</label>
                                    <div class="form-control-wrap">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form id="deleteForm" method="POST" action="{{ route('admin.botplan.destroy', $item->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
    ...
    <div class="modal fade" id="modalForm">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Bot Plan Info</h5>
                    <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <em class="icon ni ni-cross"></em>
                    </a>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.botplan.store') }}" method="POST" class="form-validate is-alter" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-label" for="full-name">Duration</label>
                                    <div class="form-control-wrap">
                                        <input type="number" step="0.001" name="duration" class="form-control" id="full-name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-label" for="email-address">ROI</label>
                                    <div class="form-control-wrap">
                                        <input type="number" step="0.001" name="roi" class="form-control" id="email-address" required>
                                    </div>
                                </div>
                            </div>
                        </div>
